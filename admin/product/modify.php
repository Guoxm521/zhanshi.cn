...
<body>
    ...
    $sort_result = select_sort($sdb, '产品中心');

    // 根据id获取内容
    $product  = new Mysql('product');
    $product_result = $product->selectByids($_GET['id']);
    $sortname = $product_result['sortname'];
    ...
    <form class="layui-form" style="width: 600px;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input" value="<?php echo $product_result['title']?>">
        ...
        <div class="layui-form-item" id="img_upload">
            ...
            <div class="layui-input-block">
                ...
                <span>文件上传</span>
                <img src="<?php echo "./../upload/".$product_result['img'] ?>" alt="" id="upload_img_show">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">文本域</label>
            <div class="layui-input-block">
                <textarea name="content" placeholder="请输入内容" class="layui-textarea"><?php echo $product_result['content'] ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
